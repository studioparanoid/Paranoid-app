  ...
  return <div className="divide-y divide-zinc-900 border-y border-zinc-900">
    {items.map((item) => {
      const content = <>
        ...
        <AppIcon name="chevron" className="h-4 w-4 shrink-0 text-zinc-800" />
      </>;
      const className = "flex min-h-16 w-full items-center gap-3 py-3 text-left transition hover:bg-zinc-950/70 focus-visible:outline focus-visible:outline-2 focus-visible:outline-red-600";
